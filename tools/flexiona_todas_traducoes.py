...
`morfologia`. O resultado é gravado em um novo arquivo, tipicamente
...
Para aplicar apenas a um código Strong específico:
    python3 tools/flexiona_traducoes.py --strong 3004
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("src/_data/nt_greek-pt_dict_new.json"),
